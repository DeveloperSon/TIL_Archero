...
{
    public Transform trRoulettePlate; 
    public GameObject trRoulettePanel; 
    public Transform trPin; 
    ...
    {
        DisplayItemSlot[ItemCnt].gameObject.SetActive ( false );
        ...
        while ( true )
        {
            ...
            trRoulettePlate.Rotate ( 0, 0, rotateSpeed );
        }
    ...
    void Result ( )
    {
        ...
        for ( int i = 0 ; i < ItemCnt; i++ )
        {
            currentDis = Vector2.Distance ( DisplayItemSlot[i].transform.position, trPin.position );
        ...
        DisplayItemSlot[ItemCnt].gameObject.SetActive(true);
